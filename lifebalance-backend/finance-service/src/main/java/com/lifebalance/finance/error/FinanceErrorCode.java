...
public final class FinanceErrorCode {
    ...
    public static final String FINANCE_ACCOUNT_INVALID = "FINANCE_ACCOUNT_INVALID";
    ...
    public static final String FINANCE_INSUFFICIENT_BALANCE = "FINANCE_INSUFFICIENT_BALANCE";
    public static final String FINANCE_ONE_OFF_TASK_INCOME_ALREADY_EXISTS =
            "FINANCE_ONE_OFF_TASK_INCOME_ALREADY_EXISTS";
    public static final String FINANCE_MONTHLY_SALARY_ALREADY_EXISTS = "FINANCE_MONTHLY_SALARY_ALREADY_EXISTS";
