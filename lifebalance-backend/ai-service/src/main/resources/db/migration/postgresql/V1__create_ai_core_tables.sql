...
BEGIN
    IF EXISTS (
        ...
        ALTER TABLE ai.ai_conversations
            ADD CONSTRAINT fk_ai_conversations_owner
            FOREIGN KEY (owner_id) REFERENCES identity.users(id) ON DELETE RESTRICT;
        ALTER TABLE ai.ai_conversations
            ADD CONSTRAINT fk_ai_conversations_actor
            FOREIGN KEY (actor_id) REFERENCES identity.users(id) ON DELETE SET NULL;
        ALTER TABLE ai.ai_messages
            ADD CONSTRAINT fk_ai_messages_owner
            FOREIGN KEY (owner_id) REFERENCES identity.users(id) ON DELETE RESTRICT;
        ALTER TABLE ai.ai_messages
            ADD CONSTRAINT fk_ai_messages_actor
            FOREIGN KEY (actor_id) REFERENCES identity.users(id) ON DELETE SET NULL;
        ALTER TABLE ai.ai_recommendations
            ADD CONSTRAINT fk_ai_recommendations_owner
            FOREIGN KEY (owner_id) REFERENCES identity.users(id) ON DELETE RESTRICT;
        ALTER TABLE ai.ai_recommendations
            ADD CONSTRAINT fk_ai_recommendations_actor
            FOREIGN KEY (actor_id) REFERENCES identity.users(id) ON DELETE SET NULL;
        ALTER TABLE ai.ai_insights
            ADD CONSTRAINT fk_ai_insights_owner
            FOREIGN KEY (owner_id) REFERENCES identity.users(id) ON DELETE RESTRICT;
        ALTER TABLE ai.ai_insights
            ADD CONSTRAINT fk_ai_insights_actor
            FOREIGN KEY (actor_id) REFERENCES identity.users(id) ON DELETE SET NULL;
        ALTER TABLE ai.ai_histories
            ADD CONSTRAINT fk_ai_histories_owner
            FOREIGN KEY (owner_id) REFERENCES identity.users(id) ON DELETE RESTRICT;
        ALTER TABLE ai.ai_histories
            ADD CONSTRAINT fk_ai_histories_actor
            FOREIGN KEY (actor_id) REFERENCES identity.users(id) ON DELETE SET NULL;
    END IF;
END $$;
